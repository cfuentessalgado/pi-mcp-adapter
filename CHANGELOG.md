...
- New env var `MCP_OAUTH_CALLBACK_HOST` binds the OAuth callback server to a chosen interface (`0.0.0.0`, a tailscale hostname, an IPv6 literal, ...). It wins over the host derived from `oauth.redirectUri`.
